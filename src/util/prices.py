...
def main():
    ...
    print(f'Number of regions to work on: {len(regions)}')

  #  for region in regions:
  #      offers.extend(get_virtual_machine_sku_prices(region, jsondata))
#    offers= get_virtual_machine_sku_prices('us-east', jsondata)
    ...
    # Print the result
    print(f'Number of rows in the "{offers}" table: {count_of_offers_inserted}')
